<template>
    <div style="word-break: break-word">
        ...
        >
            ...
            >
                {{ $t("Styles Configuration") }}
            </h5>
            <div
                class="py-2 mt-3 toggled-card"
            ...
            >
                    ...
                    <div class="relative tab">
                        ...
                        <div class="bg-[#fafafa] tab-content p-2">
                            <div class="grid grid-cols-[2fr,1fr] gap-2 mb-2">
                                <p class="ml-2">{{ $t("Steps BG Color") }}:</p>
                                <input
                                    v-model="
                ...
                <div class="tabs">
                    <div class="relative tab">
                        ...
                        <div class="bg-[#fafafa] tab-content p-2">
                            <div class="grid grid-cols-[2fr,1fr] gap-2 mb-2">
                                <p class="ml-2">{{ $t("Cart BG Color") }}:</p>
                                <input
                                    v-model="
                            ...
                            <div class="grid grid-cols-[2fr,1fr] gap-2 mb-2">
                                <p class="ml-2">{{ $t("Cart Text Color") }}:</p>
                                <input
                                    v-model="
                ...
                <div class="tabs">
                    <div class="relative tab">
                        ...
                        <div class="bg-[#fafafa] tab-content p-2 px-5">
                    ...
                    >
                        ...
                        <div v-else class="tabs">
                            <div
                                ...
                                class="mt-2 p-2 rounded-lg shadow-md option-card relative tab"
                            >
                                <select-input
                                    @update:model-value="
                                    ...
                                    >
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <button
                                                ...
                                                "
                                                type="button"
                                                class="docsHeroColorBlue mt-3 inline-flex w-full justify-center rounded-md border border-transparent bg-gray-500 px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 sm:ml-0 sm:w-full sm:text-sm"
                                            >
                                                {{ $t("Add Products") }}
                                            </button>
                                        </div>
                                ...
                                <button
                                    ...
                                    type="button"
                                    class="docsHeroColorBlue mt-3 inline-flex w-full justify-center rounded-md border border-transparent bg-blue-600 px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 sm:ml-0 sm:w-full sm:text-sm"
                                >
                                    {{ $t("Add Option ") }} +
                                </button>
                            </div>
                        ...
                        >
                            ...
                            <div
                                v-if="
                                    selectedQuestion?.configuration?.groups
                                        ?.length
                                "
                            >
                                <div
                                    v-for="(
                                        condition, index
                                    ) in selectedQuestion.configuration
                                        .conditions"
                                    :key="'condition-' + index"
                                    class="mt-2 p-2 rounded-lg shadow-md option-card relative"
                                >
                                    <font-awesome-icon
                                    ...
                                    >
                                        <font-awesome-icon
                                            @click="addOptionsCondition(index)"
                                    ...
                                    <div class="conditions">
                                        ...
                                        <button
                                            ...
                                            "
                                            @click="
                                                openConditionProductsModal(
                                                    index
                                                )
                                            "
                                            type="button"
                                            class="docsHeroColorBlue self-end inline-flex w-full justify-center rounded-md border border-transparent bg-gray-500 px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 sm:ml-0 sm:w-full sm:text-sm"
                                        >
                                            Products
                                        </button>
                                        <select-input
        ...
        <div class="grid grid-cols-[5fr,2fr] header">
            ...
            <div class="flex self-start">
                <button
                    :disabled="!surveyId && !$route.params.id"
                    @click="exportJson"
                    type="button"
                    class="mr-5 docsHeroLayoutColor self-center mt-3 inline-flex w-full justify-center rounded-md border border-transparent bg-gray-500 px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 sm:ml-0 sm:w-full sm:text-sm"
                >
                    {{ $t("Export") }}
                </button>
                <button
                    ...
                    @click="save"
                    type="button"
                    class="docsHeroLayoutColor self-center mt-3 inline-flex w-full justify-center rounded-md border border-transparent bg-gray-500 px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 sm:ml-0 sm:w-full sm:text-sm"
                >
                    {{ $t("Save") }}
                </button>
            </div>
        ...
        ></TextInput>
        <div
            v-if="!styleBarToggle && !cartToggle"
            :style="`right: ${
                configurationToggle ? '30' : '0'
            }%; top: 14%; background: #ed7d31; z-index: 1; height: auto;`"
        ...
        <div
            v-if="!configurationToggle && !cartToggle"
            :style="`right: ${
                styleBarToggle ? '22' : '0'
            }%; top: 60%; background: #ed7d31; z-index: 1; height: auto;`"
            class="absolute card px-3 py-2 bg-white-500 rounded shadow-md cursor-pointer"
            @click="styleBarToggle = !styleBarToggle"
        >
            <font-awesome-icon color="#2957a4" icon="fa-solid fa-palette" />
        </div>
        <div
            v-if="!configurationToggle && !styleBarToggle && minimizeCart"
            :style="`right: ${
                cartToggle ? '30' : '0'
            }%; top: 70%; background: #ed7d31; z-index:1; height: auto;`"
            class="absolute card px-3 py-2 bg-white-500 rounded shadow-md cursor-pointer"
    ...
    <select-product-modal
        ...
        :selectedItems="option.products"
        :questions="questions"
        :options="Object.keys(this.allOptions)"
        :products="products"
    ></select-product-modal>
    <select-product-modal
        :questions="questions"
...
export default {
    ...
    async mounted() {
        ...
        this.$store.commit("surveys/id", this.$route.params.id);
        this.$emitter.on("refresh", async () => {
            try {
                const response = await this.$store.dispatch(
                    "surveys/surveyProducts",
                    this.$route.params.id
                );
                this.surveyProducts = response?.data?.products;
                this.refresh();
            } catch (e) {
                console.log(e);
            }
    ...
    methods: {
        ...
        async cartConfigToggled(event, type) {
            ...
            const response = await this.$store.dispatch(`surveys/update`, {
                id: this.$route.params.id,
                data: {
                    addProductsManually:
        ...
        async refresh() {
            ...
            this.steps = [];
            this.$store
                .dispatch("surveys/show", { id: this.$route.params.id })
                .then((res) => {
                    document.title = "Edit Survey " + res?.data?.surveyNumber;
                    this.cart.addProductsManually =
...
<html lang="en">
    ...
    <\/script>
        ...
        addConditionsProduct(products) {
            ...
            this.addConditionMixin(this.selectedCondition); //selected condition is updated in the allConditions state
