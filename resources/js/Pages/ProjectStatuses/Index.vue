    ...
    <div>
        ...
        <div class="table-responsive">
            <table class="w-full doc-table">
                ...
                <tr
                    v-for="status in projectStatuses?.data"
                    :key="status.id"
                    ...
                    @contextmenu.stop.prevent="
                        (e) => {
                            ...
                            let route = $router.resolve(
                                `/project-statuses/${status.id}/edit?page=${page}`
                            );
                ...
                >
                    ...
                    <td class="w-px border-t">
                        <router-link
                            ...
                            class="mr-2"
                            :to="`/project-statuses/${status.id}/edit?page=${page}`"
                        >
                            <font-awesome-icon
                ...
                <tr v-if="projectStatuses?.data.length === 0">
                    <td class="px-6 py-4 border-t text-center" colspan="4">
                        {{ $t("No project status found") }}.
                    </td>
                </tr>
            </table>
        </div>
...
export default {
    ...
    data() {
        return {
            ...
            optionalItems: {
                isBtn2Show: true,
                btn2Text: this.$t("Create Project Status"),
                btn2Path: "/project-statuses/create",
            },
            page: 1,
            form: {
                search: "",
