                    ...
                    <div class="w-full">
                        <div class="form-group">
                            <MultiSelectInput
                                ...
                                @open="fetchCustomers"
                                @update:model-value="fetchSystemsAndCompanyEmployees"
                                    ...
                                    <tbody>
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                <td
                                                    class="pl-5 text-center py-2 align-top"
                                                >
                                                    <div class="lg:w-2/3">
                                                        <number-input
                                                            class=""
...
export default {
    ...
    async mounted() {
        ...
        // const response = await this.$store.dispatch("invoiceTemplates/fetchData");
    ...
    methods: {
        ...
        async store() {
            ...
            try {
                ...
                this.$router.push("/invoices-templates");
            } catch (e) {
                console.log(e);
                this.disabled = false;
            }
