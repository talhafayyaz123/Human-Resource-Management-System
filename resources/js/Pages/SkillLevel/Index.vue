    ...
    <div>
        ...
        <div class="table-responsive">
            <table class="w-full doc-table">
                    ...
                    @click.stop.right="
                        (e) => {
                            ...
                            let route = $router.resolve(
                                `/skill-level/${skillLevel.id}/edit`
                            );
                    ...
                    <td class="w-px border-t">
                        <div class="flex items-center gap-x-2">
                            <router-link
                                ...
                                class="px-1 mr-2"
                                :to="`/skill-level/${skillLevel.id}/edit`"
                            >
                                <font-awesome-icon
                            ...
                            <button
                                ...
                                @click.stop="destroy(skillLevel.id)"
                            >
                                <font-awesome-icon
                ...
                <tr v-if="skillLevel?.data.length === 0">
                    <td class="px-6 py-4 border-t text-center" colspan="5">
                        {{ $t("No skill level found") }}.
                    </td>
                </tr>
            </table>
        </div>
...
export default {
    ...
    data() {
        return {
            ...
            optionalItems: {
                isBtn2Show: true,
                btn2Text: this.$t("Create Skill Level"),
                btn2Path: "/skill-level/create",
            },
            page: 1,
            form: {
                search: "",
        ...
        async destroy(id) {
            this.$swal({
                ...
                if (result.isConfirmed === true) {
                    try {
                        await this.$store.dispatch("skillLevels/destroy", id);
