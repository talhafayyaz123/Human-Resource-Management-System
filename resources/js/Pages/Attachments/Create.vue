    ...
    <div>
        ...
        <form @submit.prevent="store">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="grid items-center grid-cols-3 gap-6">
                        ...
                        <div class="w-full">
                            <div class="form-group">
                                <label class="form-label">{{ $t("Contract End") }}:</label>
                                <datepicker
                                    :clearable="false"
                                    ...
                                    :class="errors.contractEndAt ? 'error' : ''"
                                />
                                <div
            ...
            <div class="flex items-center justify-end mt-4">
                <router-link to="/attachments" class="primary-btn mr-3">
                    <span class="mr-1">
...
export default {
    ...
    async mounted() {
        // fetch the softwares, documentServices, contractTypes if not already fetched
        try {
    ...
    data() {
        return {
            ...
            form: {
                ...
                contractEndAt: "",
                selectUser: false,
                addProductsToCustomerLicenses: false,
            },
        };
    },
    methods: {
        /**
         * hit the attachments create API and redirect to attachments listing upon success
         */
        async store() {
            try {
                ...
                await this.$store.dispatch("attachments/create", {
                    ...
                    contractFields: this.$refs.contractFields.contractFields,
                    renewalPeriod: !!this.form.renewalPeriod ? 1 : 0,
                    rightOfTermination: !!this.form.rightOfTermination ? 1 : 0,
                });
