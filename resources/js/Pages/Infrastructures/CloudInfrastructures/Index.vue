    ...
    <div>
        ...
        <div class="table-responsive">
            <table class="w-full doc-table">
                ...
                <template v-for="system in systemCloud?.data" :key="system.id"

                   >
                    <tr @contextmenu.stop.prevent="
                    (e) => {
                        e.preventDefault();
                        let route = $router.resolve(
                            `/infrastructures/cloud-infrastructures/${system.id}/edit?page=${page}`
                        );
                ...
                ">
                        ...
                        <td class="w-px border-t">
                            <div class="flex justify-around">
                                <router-link
                                    :to="`/infrastructures/cloud-infrastructures/${system.id}/edit?page=${page}`"
                                >
                                    <font-awesome-icon
    ...
    data() {
        return {
            ...
            optionalItems: {
                ...
                btn2Path: "/infrastructures/cloud-infrastructures/create",
            },
            page: 1,
            form: {
                search: "",
                    ...
                    this.$store
                        ...
                        .then((res) => {
                            res?.data?.data.forEach((pool) => {
                                this.$store.dispatch("serverPools/update", {
                                    id: pool?.id,
                                    cluster_id: "",
                                });
                            });
