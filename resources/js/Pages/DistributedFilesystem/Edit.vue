            ...
            <div class="card mt-3">
                ...
                <div class="card-body">
                    <div class="flex flex-wrap">
                        ...
                        />
                        <div
                            class="pb-8 pr-6 w-full lg:w-1/2 flex items-center"
                        >
                            <label class="inline-flex items-center">
                                <input
                                    type="checkbox"
                                    class="form-checkbox h-5 w-5 text-gray-600"
                                    v-model="serverForm.isMaster"
                                />
    ...
    methods: {
        ...
        async fetchData() {
            try {
                const response = await this.$store.dispatch(
                    "distributedFilesystem/show",
                    this.$route.params.id
                );
                const modelData = response?.data?.distributedFilesystem ?? {
                    name: "",
                    subType: "",
                    instanceType: "",
                };
        ...
        async update() {
            try {
                ...
                await this.$store.dispatch("distributedFilesystem/update", {
                ...
                this.$router.push("/distributed-filesystem");
            } catch (e) {
                console.log(e);
            }
        },
