    ...
    <div>
                ...
                <div class="grid items-center grid-cols-3 gap-6">
                    <div class="w-full">
                        <div class="form-group">
                            <!-- Category Dropdown -->
                            <select-input
                                :isReadOnly="invoiceStaticStatus != 'draft'"
                                :label="$t('Category')"
                                :required="true"
                                :key="form.category"
                    ...
                    <div class="w-full">
                        <div class="form-group">
                            <MultiSelectInput
                                ...
                                "
                                @update:model-value="
                                    fetchSystemsAndCompanyEmployees(true)
                                "
                    ...
                    <div class="w-full">
                        <div class="form-group">
                            ...
                            >
                                ...
                                >
                                <datepicker
                                    :disabled="form.invoiceStatus != 'draft'"
                                    :clearable="false"
                                    :enable-time-picker="false"
                                    auto-apply
                                    :close-on-auto-apply="false"
                    ...
                    <div class="w-full">
                        <div class="form-group">
                            ...
                            <select-input
                                :required="true"
                                :key="form.invoiceStatus"
                                v-model="form.invoiceStatus"
                                :error="errors.invoiceStatus"
                                :label="$t('Invoice Status')"
                            >
                                <template
                                    v-for="(status, index) in invoiceStatuses"
                                    :key="index"
                                >
                                    <option
                                        v-if="this.invoiceStatusKey <= index"
                                        :value="status"
                                    >
                                        {{ $t(status) }}
                                    </option>
                    ...
                    <div class="w-full">
                        <div class="form-group">
                            ...
                            <MultiSelectInput
                                ...
                                trackBy="id"
                                moduleName="projects"
                                :isDisabled="invoiceStaticStatus != 'draft'"
                            />
                        </div>
                    </div>
                    <div class="w-full">
        ...
        <form @submit.prevent="store()">
            ...
            <div class="card my-5">
                <div class="card-header">
                    <h3 class="card-title flex justify-between">
                        ...
                        {{
                            pInvoices?.draftStatusChangeDate
                                ? $dateFormatter(
                                      formatDateLite(
                                          pInvoices?.draftStatusChangeDate
                                      ),
                ...
                <div class="flex flex-wrap py-5">
                    <div class="sm:px-6 w-full">
                        <div style="padding-top: 0" class="bg-white py-4">
                            ...
                            <span v-if="form.category === 'license'">
                                            ...
                                            >
                                                ...
                                                >
                                                    ...
                                                    <td>
                                                        <div class="">
                                                            <input
                                                                class="appearance-none border-2 input-width border-gray-200 rounded py-2 px-2 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500"
                                                                type="number"
                                                                @input="
                                ...
                                <div
                                    v-if="
                                        Object.keys(softwareLicences).length >
                                            0 && form.category === 'license'
                                    "
                                    style="
            ...
            <div class="flex items-center justify-end mt-4">
                <router-link to="/invoices" class="primary-btn mr-3">
                    <span class="mr-1">
                ...
                <loading-button
                    v-if="
                        ...
                        form.invoiceStatus !== 'draft'
                    "
                    :loading="isLoading"
                    @click.prevent="cancelInvoice(true)"
                    class="btn-red mr-3"
                    >{{ $t("Cancel Invoice") }}</loading-button
                >
                ...
                >
                <loading-button
                    v-if="(pInvoices?.invoiceStatus ?? '').includes('warning')"
                    @click.prevent="generate('pdf', true)"
                    :loading="isLoading"
                    class="secondary-btn mr-3"
                    >{{ $t("Generate Warning") }}</loading-button
                >
                <loading-button
                    v-if="!isCorrection && form.systems?.id"
                    @click.prevent="executeSSH"
                    class="btn-green mr-3"
                    >{{ $t("Install System") }}</loading-button
                >
                <loading-button
                    :loading="isLoading"
                    @click="store()"
            ...
            <!-- <div class="max-w-6xl flex flex-row-reverse justify-right">
                <loading-button
                    ...
                    @click="store()"
                    class="btn-green"
                    >{{ $t("Update Invoices") }}</loading-button
                >
...
export default {
        ...
        return {
            ...
            breadcrumbItems: [
                ...
                },
                {
                    ...
                    to: "/invoices?page=" + this.$route.query.page,
                },
                {
                    text: "Edit",
                    active: true,
    ...
    methods: {
        ...
        async cancelInvoice(isCopy = false) {
            try {
                let products = [];
                ...
                if (this.form.category === "license") {
                    ...
                    this.form.totalAmountWithoutTax =
                        this.totalAmountWithoutTaxLicences * -1;
                    ...
                    this.form.totalAmountWithoutTax =
                        this.totalAmountWithoutTaxMaintenance * -1;
                    this.form.totalTaxAmount = this.$formatter(
                    ...
                    this.form.totalAmountWithoutTax = this.computeNettoAms * -1;
                    this.form.totalTaxAmount = this.$formatter(
                ...
                if (!isCopy) {
                    storeResponse = await this.$store.dispatch(
                        "invoices/update",
                        {
                            ...
                            data: {
                                ...this.form,
                                dueDate:
                                    this.form.dueDate?.toLocaleDateString(),
                                startDate:
                                    this.form.startDate?.toLocaleDateString(),
                                endDate:
                                    this.form.endDate?.toLocaleDateString(),
                                draftStatusChangeDate: this.form
                                    .draftStatusChangeDate
                    ...
                    this.form.invoiceType = "invoice-storno";
                    this.form.invoiceStatus = "draft";
                    ...
                    this.sendEloRequest(response?.data?.id, "createInvoice");
                }
                        ...
                        products.map((product) => {
                            return {
                                ...
                                paymentPeriod:
                                    this.periods?.data?.find(
                                        (period) =>
                                            period.id === product.paymentPeriod
                                    ) ?? product.paymentPeriod,
                            };
                        }),
                ...
                this.$router.push("/invoices?page=" + this.returnPage);
            } catch (e) {
                console.log(e);
            }
        },
        ...
        async refresh() {
            ...
            try {
               ...
               this.referenceInvoices=invoices?.data?.invoices;
                ...
                document.title = "Edit Invoice " + this.pInvoices?.category;
                ...
                this.form = {
                    ...
                    externalOrderNumber: this.pInvoices?.externalOrderNumber,
                    ...
                    invoiceType: this.pInvoices.invoiceType,
                    recreateAfter: this.pInvoices.recreateAfter,
                    ...
                    startDate: this.pInvoices?.startDate
                        ? new Date(
                              typeof this.pInvoices?.startDate === "string"
                                  ? this.pInvoices?.startDate
                                        .replace(/-/g, "\/")
                                        .replace(/T.+/, "")
                                  : ""
                          )
                    ...
                    endDate: this.pInvoices?.endDate
                        ? new Date(
                              typeof this.pInvoices?.endDate === "string"
                                  ? this.pInvoices?.endDate
                                        .replace(/-/g, "\/")
                                        .replace(/T.+/, "")
                                  : ""
                          )
                    ...
                    referenceInvoiceDetail: this.pInvoices?.referenceInvoiceDetail ?? {},
                    contactPerson: "",
                };
                if(this.pInvoices?.referenceInvoice){
             
              this.referenceInvoiceId ={id:this.pInvoices?.referenceInvoice};
              
                }
               
                if(this.form.invoiceStatus==='draft'){
                    this.isInvoiceEditable=false;
                }else{
                    this.isInvoiceEditable=true;
                }

                // since the dueDate is changed when the draftStatusChangeDate is changed, the original dueDate value is lost
                // we set the value from the response again after a little delay
                setTimeout(() => {
                    this.form.dueDate = new Date(
                        this.pInvoices?.dueDate
                            .replace(/-/g, "\/")
                            .replace(/T.+/, "")
                    );
                }, 1);
        ...
        async store(isCopy = false, byPass = false) {
            if (this.isCorrection) {
                ...
                try {
                    ...
                    if (this.pInvoices?.invoiceStatus !== "draft" && !isCopy) {
        ...
        /**
         * creates the payload that will sent with the generate pdf API
         * @param {documentType} the type of document to be generated e.g pdf, docx
         * @param {warning} generate the pdf for warning level if true by making use of the document template set in invoice reminder level module
         */
        generate(documentType, warning = false) {
            let products = [];
            let categories = []; // if the category is 'service' and groupedBy is 'category' then map the categories to this array to send along the payload
            if (this.form.category === "license") {
                this.form.totalAmount = this.totalAmountLicences;
                ...
                if (this.form.groupedBy === "category") {
                    const productsByCategory =
                        this.formatServiceProductDetails();
                    products = {
                        productsByCategory,
                        totalPrice: this.form.totalAmount,
                        priceWithoutTax: this.form.totalAmountWithoutTax,
                        formCategory: "serviceByCategory",
                    };
                    categories = this.categories.map((category) => {
                        return {
                            id: category.id,
            ...
            this.generateProcessTemplate(
                (products?.productsByCategory ?? products).map((product) => {
                    return {
                        ...product,
                        paymentPeriod:
                            this.periods?.data?.find(
        ...
        async generateProcessTemplate(
            ...
            if (warning) {
                const response = await this.$store.dispatch(
                    ...
                    {
                        levelName: this.pInvoices?.invoiceStatus,
                    }
                );
                warningLevel = response?.data?.data ?? {};
                templateId = response?.data?.data?.documentTemplateId ?? "";
            } else {
                templatePayload =
                    this.invoiceTemplateEnums[
                        this.form.invoiceType ?? "invoice"
                    ];
                //Get template id
                templateId = await this.$store.dispatch(
            ...
            if (templateId != "") {
                this.$store.commit("isLoading", true);
                const invoiceDate = this.form?.draftStatusChangeDate
                    ? this.form.draftStatusChangeDate?.toLocaleDateString()
                    : this.$dateFormatter(
                ...
                const payload = {
                    ...
                    products: products,
                    performanceRecord: this.form.performanceRecord ?? "",
                    termsOfPayment: this.form?.termsOfPayment,
                ...
                const filename =
                    "invoice-" +
                    (invoiceNumber == null ? "draft" : invoiceNumber) +
                    `.${documentType}`;
                const response = await this.$store.dispatch(
                ...
                if (!isUpdate) await this.store(false, true);
            }
        },
        formatServiceProductDetails() {
            const productsByCategory = [];
            this.categories.forEach(function (category) {
                ...
                productsByCategory.push(categoryObj);
            });
