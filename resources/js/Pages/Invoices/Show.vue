    ...
    <div>
                ...
                <div class="flex flex-wrap">
                    ...
                    <div class="pb-8 pr-6 w-full lg:w-1/3">
                        ...
                        <p>
                            {{
                                $dateFormatter(
                                    formatDateLite(new Date(form?.dueDate)),
                                    globalLanguage
                                )
                            }}
                        </p>
                    ...
                    <div class="pr-6 w-full lg:w-1/3 mb-8">
                        ...
                        >
                        <p>
                            {{ pInvoices.externalOrderNumber ?? "-" }}
                        </p>
                    </div>
                    <div class="pr-6 w-full lg:w-1/3 mb-8">
                        <label
                            class="form-label font-bold"
                            >{{ $t("Recreate After") }}:</label
                        >
                        <p>
                            {{ pInvoices.recreateAfter ?? "-" }}
                        </p>
                    </div>
                    <div class="pr-6 w-full lg:w-1/3 mb-8">
                        <label
        ...
        <form @submit.prevent="store">
            ...
            <div class="flex items-center justify-end mt-4">
                <loading-button
                    @click.prevent="generateProcessTemplate('pdf')"
                    :loading="isLoading"
                    class="secondary-btn"
                    >{{ $t("Generate PDF") }}</loading-button
                >
                <loading-button
                    @click.prevent="generateProcessTemplate('docx')"
                    :loading="isLoading"
                ...
                <loading-button
                    ...
                    @click.prevent="generateProcessTemplate('pdf', true)"
                    :loading="isLoading"
...
export default {
    ...
    methods: {
        ...
        async generateProcessTemplate(documentType, warning = false) {
            let products = [];
            ...
            if (templateId != "") {
                ...
                await this.$store.commit("isLoading", true);
                const filename =
                    "invoice-" +
