<template>
    ...
    <div style="grid-template-rows: repeat(auto-fill, auto)" class="grid gap-3">
        ...
        <div class="flex items-center justify-end mt-4">
            ...
            <loading-button :loading="isLoading" @click="update" class="secondary-btn">
                <span class="mr-1">
    ...
    methods: {
        ...
        async update() {
                    ...
                    if (this.softwareLicences.hasOwnProperty(key)) {
                        if (key === "licenseReport") {
                            if (
                                ...
                                typeof this.softwareLicences[key]?.[
                                    "files"
                                ]?.[0] === "object"
                            ) {
                                const file =
            ...
            try {
                ...
                await this.$store.dispatch(`offerRequests/update`, {
                    id: this.$route.params.id,
                    data: payload,
                });
                this.$store.dispatch(`offerRequests/list`);
                this.$router.push(`/offer-requests?page=`+this.returnPage);
            } catch (e) {}
        },
    },
    components: {
