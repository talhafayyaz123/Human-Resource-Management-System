    ...
    <form @submit.prevent="store">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">{{ $t('Consulting Teams') }}</h3>
        </div>
        <div class="card-body">
      ...
      <div class="flex items-center justify-end mt-4">
        <loading-button v-if="$can(`${$route.meta.permission}.create`)" :loading="isLoading" class="secondary-btn">
          <span class="mr-1">
  ...
  methods: {
    ...
    async store() {
      try {
        ...
        await this.$store.dispatch("userTeams/consultingTeamsSave", {
