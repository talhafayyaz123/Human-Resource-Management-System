        ...
        <div class="table-responsive">
            <table class="w-full doc-table">
                <tr class="text-left font-bold">
                    ...
                    <th
                        @click="sort('audience', 'news')"
                        class="pb-4 pt-6 px-6 cursor-pointer"
                    >
                        {{ $t("Audience") }}
                        <font-awesome-icon
                            v-if="form.sortBy === 'audience'"
                            class="cursor-pointer ml-2"
                            :icon="`fa-solid fa-sort-${
                                form.sortOrder === 'asc' ? 'up' : 'down'
                            }`"
                    ...
                    @contextmenu.stop.prevent="
                        (e) => {
                            ...
                            let route = $router.resolve(
                                `/customer-portal-news/${item.id}/edit?page=${page}`
                            );
                ...
                >
                    <td class="border-t">
                        <router-link
                            :to="`/customer-portal-news/${item.id}/edit?page=${page}`"
...
export default {
    computed: {
        ...mapGetters("customerPortalNews", ["news"]),
    },
    components: {
        Pagination,
        SearchFilter,
    ...
    data() {
        return {
            ...
            optionalItems: {
                isBtn2Show: true,
                btn2Text: this.$t("Create News"),
                btn2Path: "/customer-portal-news/create",
            },
            form: {
                search: "",
