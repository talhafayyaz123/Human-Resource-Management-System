    ...
    <div>
        ...
        <form @submit.prevent="update">
                ...
                <div class="card-body">
                    <div class="grid items-center grid-cols-2 gap-6">
                        ...
                        <div class="w-full">
                            <div class="form-group">
                                <MultiSelectInput
                                    :isDisabled="form.status === 'beauftragt'"
                                    class=""
            ...
            <div class="flex items-center justify-end mt-4">
                ...
                <loading-button
                    @click.prevent="createInvoiceTemplate"
                    :loading="isLoading"
                    class="secondary-btn mr-3"
                >{{ $t("Create Invoice Template") }}</loading-button
                >
                <loading-button
...
export default {
    ...
    methods: {
        ...
        /**
         * hits the create invoice template API
         */
        async createInvoiceTemplate() {
            this.$store.commit("isLoading", true);
            try {
                await this.$store.dispatch(
                    "outboundedContracts/createInvoiceTemplate",
                    this.$route.params.id
                );
            } catch (e) {
                console.log(e);
                    ...
                    ...attachments.map((attachment) => {
                        ...
                        return {
                                ...
                                (field) => {
                                    ...
                                    if (field?.type === "time") {
                                        ...
                                        if (field?.type === "offer") {
                                            ...
                                            orderConfirmationProducts = value;
                                        }
                                    }
                                    return {
                                        ...field,
                            ...
                            orderConfirmationProducts:
                                orderConfirmationProducts.map((product) => {
                                    return {
                                        ...product,
                                        nettoTotal: product.totalNetto,
                                        taxRate:
            ...
            try {
                ...
                let attachments = this.attachments.map((attachment, index) => {
                    ...
                    return {
                        id: attachment.id,
                        contractAttachmentId:
                            typeof attachment.contractAttachmentId === "number"
                                ? attachment.contractAttachmentId
                                : null,
                        slaServiceTimeId:
