            ...
            <table class="w-full doc-table">
                ...
                <tr
                    ...
                    @contextmenu.stop.prevent="
                        (e) => {
                            e.preventDefault();
                            let route = $router.resolve(`/product-software/${software.id}/edit?page=${page}`);
                    ...
                    <td class="w-px border-t">
                        <div class="flex justify-between">
                            <router-link
                                ...
                                :to="`/product-software/${software.id}/edit?page=${page}`"
                            >
                                <font-awesome-icon
                            ...
                            <button
                                ...
                                @click.stop="destroy(software.id)"
                            >
                ...
                <tr v-if="softwares?.data.length === 0">
...
export default {
    ...
    data() {
        return {
            ...
            optionalItems: {
                isBtn2Show: true,
                btn2Text: this.$t("Create Software"),
                btn2Path: "/product-software/create",
            },
            form: {
                search: "",
                sortBy: "id",
    ...
    methods: {
        async refresh(bypass) {
            if (!this.softwares?.data.length || bypass)
        ...
        async destroy(id) {
            this.$swal({
                ...
                if (result.isConfirmed === true) {
                    try {
                        await this.$store.dispatch("softwares/destroy", id);
                        this.refresh(true);
                    } catch (e) {}
                }
            });
