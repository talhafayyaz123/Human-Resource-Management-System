                    ...
                    <div class="card-header">
                        <h3 class="card-title flex justify-between">
                            <h1 class="secondary-color text-2xl">
                                ORDER {{ this.modelData?.orderNumber }} /
...
export default {
    ...
    methods: {
        ...
        fetchPartnerContactPerson() {
            return new Promise(async (resolve, reject) => {
                try {
                    this.$store
                        .dispatch("auth/show", {
                            id: this.modelData?.contactPartnerPerson,
                        })
                        .then((res) => {
                            this.form.contactPartnerPerson = res.data;
                        });
        ...
        async fetchCompanyLeadEmployees(update = false) {
            ...
            return new Promise(async (resolve, reject) => {
                try {
                    ...
                    if (this.modelData?.contactPartnerPerson)
                        await this.fetchPartnerContactPerson();
                } catch (e) {
                    console.log(e);
                    reject(e);
                }
            ...
            return new Promise(async (resolve, reject) => {
                try {
                    ...
                    if (!!this.form.partner?.id) {
                        await this.fetchReciverCompany();
                        await this.fetchCompanyByPartner();
                    }
                    ...
                    await this.fetchCompanyLeadEmployees(true);
                    ...
                    document.title = "Edit Order " + this.modelData.orderNumber;
                    resolve();
                } catch (e) {
                    reject(e);
                } finally {
