...
export class RectPlaceholderExtension implements PlaceholderExtension {
    public static create(
        ...
        return new RectPlaceholderExtension(
            configuration ?? defaultConfiguration
        );
    }

    public readonly gapSize = new Vector(
        defaultConfiguration.gapWidth,
        defaultConfiguration.gapHeight
    );

    private constructor(
        private readonly configuration: RectPlaceholderConfiguration
    ) {}
