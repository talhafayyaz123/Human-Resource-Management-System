...
export class ContainerStepExtension implements StepExtension<SequentialStep> {
    public static create(
        configuration?: ContainerStepExtensionConfiguration
    ): ContainerStepExtension {
        return new ContainerStepExtension(
    ...
    private constructor(
        private readonly configuration: ContainerStepExtensionConfiguration
    ) {
        this.configuration = configuration;
    }

    public readonly createComponentView =
