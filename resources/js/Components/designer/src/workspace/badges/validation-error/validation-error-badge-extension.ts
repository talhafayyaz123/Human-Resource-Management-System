...
export class ValidationErrorBadgeExtension implements BadgeExtension {
    public static create(
        configuration?: ValidationErrorBadgeExtensionConfiguration
    ): ValidationErrorBadgeExtension {
        return new ValidationErrorBadgeExtension(
    ...
    private constructor(
        private readonly configuration: ValidationErrorBadgeExtensionConfiguration
    ) {}
    ...
    public createForStep(
        ...
        return ValidationErrorBadge.createForStep(
            parentElement,
            stepContext,
            componentContext,
    ...
    public createForRoot(
        parentElement: SVGElement,
        componentContext: ComponentContext
    ): Badge {
        return ValidationErrorBadge.createForRoot(
            parentElement,
            componentContext,
            (this.configuration ?? defaultConfiguration).view
        );
