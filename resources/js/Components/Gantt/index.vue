                ...
                >
                    ...
                    >
                        <div class="vuecal__flex" row="row" grow="grow">
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                {{ $dateFormatter(resource.plannedStartDate, globalLanguage) }}
                                            </td>
                                            <td
                                                v-if="resource.id != 0"
                                                style="
                                                ...
                                                "
                                            >
                                                <!-- {{ resource.plannedFinishedDate }} -->
                                                {{ $dateFormatter(resource.plannedFinishedDate, globalLanguage) }}
                                            </td>
                                            <td
                                                v-if="resource.id != 0"
                                                style="
                                        ...
                                        >
                                            ...
                                            <td
                                                ...
                                                "
                                            >
                                                {{ $dateFormatter(event.startDate, globalLanguage) }}
                                            </td>
                                            <td
                                                style="
                                                    padding-left: 1rem;
                                                ...
                                                "
                                            >
                                                {{ $dateFormatter(event.endDate, globalLanguage) }}
                                            </td>
                                            <td
                                                class="overflow-text-gantt"
                                                style="
                            ...
                            <!-- <span class="arrow-line" style="height: 50px; width: 1px; background-color: black;"></span> -->
                            <div
...
export default {
    ...
    mounted() {
        ...
        //   document.querySelector(".arrow-line").style.height = (e.screenY - document.querySelector(".arrow-line").getBoundingClientRect().y) - 65 + "px"
        //   document.querySelector(".arrow-line").style.transform = "rotateZ(45deg)";
        // })
        this.$nextTick(() => {
            this.computetaskHours();
        });
