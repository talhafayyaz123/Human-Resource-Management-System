<template>
    <div
        ...
        class="feeds-col mention-stream-posts feeds-overflow mentioned-stream stream-columns"
    >
        <div
            class="post-card"
        ...
        >
            <ul>
                <li class="post-card-data">
                    <div class="post-header">
                        <div class="user-det">
                            ...
                            ></div>
                            <!-- <img src="@/assets/images/avatar-1.png" alt="" class=""> -->
                                ...
                                <div class="input-group">
                                    ...
                                    <div class="input-group-append">
                                        <span
                                            ...
                                            "
                                            class="input-group-text cursor-pointer send-icon"
                                        >
                                            <icon name="sendIcon" />
                                        </span>
                                    </div>
                ...
                <li
                    v-for="(comment, index) in this.streamComments[feedIndex]"
                    :key="index"
            ...
            >
                ...
                <div class="" v-if="this.streamComments[feedIndex]?.length > 5">
                    <p
...
export default {
    ...
    methods: {
        ...
        //         this.selectedImageDisplay = event.target.result;
        ...
        async mentionFeedUser(user, index) {
            ...
            if (lastMentionIndex !== -1) {
                ...
                this.mentionedStream[index].text = "@" + user.first_name + " ";
            }
