<template>
    ...
    >
        ...
        >
            <template #arrow-prev>
                <slot name="arrow-prev">&nbsp;<i class="angle"></i>&nbsp;</slot>
            </template>
            <template #arrow-next>
                <slot name="arrow-next">&nbsp;<i class="angle"></i>&nbsp;</slot>
            </template>
        ...
        <div class="vuecal__flex vuecal__body" v-if="!hideBody" grow="grow">
            <transition
        ...
        previousNext(next = true) {
            ...
            switch (viewId) {
                ...
                case "day":
                    ...
                    if (isDayHidden) {
                        const daysWithIndex = this.weekDays.map((day, i) => ({
                            ...day,
                            i,
                        }));
                        let dayToShow = null;
    ...
    computed: {
        ...
        viewCells() {
            ...
            switch (this.view.id) {
                ...
                case "week": {
                    todayFound = false;
                    const firstDayOfWeek = this.view.startDate.subtractDays(5);
