<template>
    ...
    <div
        class="vuecal__flex vuecal ml2 mr1 vuecal--blue-theme"
        column="column"
        :class="cssClasses"
        ref="vuecal"
        :lang="locale"
    >
        ...
        <vuecal-header
            ...
            :week-days="weekDays"
            :calender-week-days="calenderWeekDays"
            :has-splits="hasSplits"
            :day-splits="daySplits"
            :switch-to-narrower-view="switchToNarrowerView"
        >
            <template #view-title>
                <p v-if="view?.id === 'week'" style="font-size: 0.9rem">
                    {{ viewTitle }}
                </p>
            </template>
            <template #legend>
                ...
                >
                    <div class="flex items-center">
                        <div
                            ...
                            "
                        ></div>
                        <p style="font-size: 1rem">Pending</p>
                    </div>
                    <div class="flex items-center">
                        <div
                            class="mr-2"
                            ...
                            "
                        ></div>
                        <p style="font-size: 1rem">Approved</p>
                    </div>
                    <div class="flex items-center">
                        <div
                            class="mr-2"
                            ...
                            "
                        ></div>
                        <p style="font-size: 1rem">Rejected</p>
                    </div>
                    <div class="flex items-center">
                        <div
                            class="mr-2"
                            ...
                            "
                        ></div>
                        <p style="font-size: 1rem">Illness</p>
                    </div>
                </div>
            </template>
            <template #arrow-prev>
                <slot name="arrow-prev"
                    >&nbsp;<i class="angle mb-1 ml-1"></i>&nbsp;</slot
                >
            </template>
            <template #arrow-next>
                <slot name="arrow-next"
                    >&nbsp;<i
                        :class="[
                            this.view.id === 'year' ? 'text-gray-300' : '',
                            'angle',
                            'mb-1',
                            'mr-1',
                        ]"
            ...
            <template #today-button>
                <slot name="today-button"
                    ><span class="default">{{ texts.today }}</span></slot
                >
            </template>
            <template #title>
                <slot name="title" :title="viewTitle" :view="view">
                    <select
                        v-if="view.id !== 'year'"
                        @input="previousNext(false, true, $event)"
            ...
            <template
                #weekday-heading="{ heading, view }"
                v-if="$slots['weekday-heading']"
            >
                <slot
            ...
            <template #split-label="{ split }" v-if="$slots['split-label']">
                <slot name="split-label" :split="split" :view="view.id"></slot>
            </template>
        </vuecal-header>
        <div
            :style="`${loading ? 'opacity: 0; min-height: 500px' : ''}`"
        ...
        >
            ...
            >
                ...
                >
                        ...
                        <template #event="{ event, view }">
                            <slot name="event" :view="view" :event="event">
                                <div
                                    ...
                                    v-if="
                                        editEvents.title && event.titleEditable
                                    "
                    ...
                    <div
                        class="vuecal__bg"
                        :class="{ vuecal__flex: !hasTimeColumn }"
                        column="column"
                    >
                        <div class="vuecal__flex" row="row" grow="grow">
                            <div
                                style="width: 20%"
                            ...
                            >
                                <table
                                    ...
                                    "
                                    class="vuecal__flex vuecal__cells week-view"
                                >
                                    <div
                                    ...
                                    >
                                        ...
                                        <tr
                                            v-for="event in resource.rowExpanded
                                                ? resource.events
                                                : 0"
                                            :key="'event-' + event.id"
                                            style="
                            ...
                            <div
                                ...
                                v-if="showWeekNumbers && isMonthView"
                                column="column"
                            >
                                <div
                                ...
                                >
                                    <slot
                                        name="week-number-cell"
                                        :week="getWeekNumber(i - 1)"
                                        >{{ getWeekNumber(i - 1) }}</slot
                                    >
                                </div>
                            </div>
                            <div
                            ...
                            >
                                ...
                                <weekdays-headings
                                    ...
                                    :style="
                                        cellOrSplitMinWidth
                                            ? `min-width: ${cellOrSplitMinWidth}px`
                                            : ''
                                    "
                                >
                                    <template
                                ...
                                <all-day-bar
                                    v-if="
                                        showAllDayEvents &&
                                        hasTimeColumn &&
                                        ((isWeekView && cellOrSplitMinWidth) ||
                                            (isDayView &&
                                                hasSplits &&
                                                minSplitWidth))
                                    "
                                ...
                                >
                                    <vuecal-cell
                                        ...
                                        @addEvent="
                                            recalculatetaskHoursAndEmitAddEvent
                                        "
                                        @addEventReverse="
                                            recalculatetaskHoursAndEmitAddEventReverse
                                        "
                                        @removeEvent="
                                            recalculatetaskHoursAndEmitRemoveEvent
                                        "
                                        @removeEventReverse="
                                            recalculatetaskHoursAndEmitRemoveEventReverse
                                        "
                                        :options="$props"
                                        :edit-events="editEvents"
                                        :data="cell"
                                            ...
                                            >
                                                ...
                                                <div
                                                    ...
                                                    :key="
                                                        ...
                                                        event.resourceId
                                                    "
                                                    class="vuecal__event-title cursor-pointer"
                                                    v-else-if="event.title"
                                                    v-html="
                                                ...
                                                >
                                                    ...
                                                    ><small
                                                        class="days-to-end"
                                                        v-if="event.daysCount &gt; 1 && (event.segments[cell.formattedDate] || {}).isFirstDay"
                                                        >&nbsp;+{{
                                                            event.daysCount - 1
                                                        }}{{
                                                            (
            ...
            <div class="vuecal__scrollbar-check" v-if="!ready">
                <div></div>
            </div>
        </div>
    </div>
    <Modal
        title="Edit Task Hours"
        width="25%"
        v-if="toggleTasksModal"
        @toggleModal="toggleTasksModal = $event"
    >
        <template #body>
            <div class="flex flex-wrap -mb-8 -mr-6 p-8">
                <text-input
                    v-model="editHours.hours"
...
export default {
    ...
    provide() {
        return {
            ...
            showBalance: computed(() => this.showBalance),
        };
    },
        ...
        return {
            ...
            table: {
                headers: [
                    ...
                    { label: "Spent Time", key: "spentTime" },
                    { label: "Remaining Time", key: "neededTime" },
                ],
            },
            ...
            utils: {
                ...
                date:
                    (this.disableDatePrototypes
                        ? dateUtils.removePrototypes()
                        : false) || dateUtils,
                cell: null,
    ...
    methods: {
        onCellClick(cell) {
            if (this.view.id === "year") {
                this.switchView("month", cell.startDate);
                this.$emit("view", "month");
            } else if (this.view.id === "month") {
                this.switchView("week", cell.startDate);
                this.next();
                this.$emit("view", "week");
            }
        },
        ...
        async updateTaskHours() {
            ...
            event.taskHours[this.editHours.key].hours = +this.editHours.hours;
            event.employeeId = event.resourceId;
            event.plannedStartDate = event.startDate.format("YYYY-MM-DD");
            event.plannedFinishedDate = event.endDate.format("YYYY-MM-DD");
            let estimatedTime = 0;
            for (let key in event.taskHours) {
                estimatedTime += +event.taskHours[key]?.hours ?? 0;
            }
            event.estimatedTime = estimatedTime;
            event.remainingTime = estimatedTime;
            try {
            ...
            this.resources[resourceIndex].events[eventIndex] = { ...event };
            this.cancel();
        },
        cancel() {
            this.event = {};
        ...
        openCustomHoursModal(event, key) {
            this.event = event;
            this.editHours = { key: key, hours: event.taskHours[key].hours };
            this.toggleTasksModal = true;
        },
        computetaskHours() {
            let resources = JSON.parse(JSON.stringify(this.resources)); //to make the copy unreactive
            resources.forEach((resource) => {
                resource.events.forEach((event) => {
                    ...
                    const hoursPerDay =
                        estimatedTime / Object.keys(event.taskHours).length;
                    for (let key in event.taskHours) {
                        event.taskHours[key].hours = +hoursPerDay.toFixed(2);
                    }
                });
            });
            this.$emit("resourcesChanged", resources);
        },
        recalculatetaskHoursAndEmitAddEvent(event) {
            this.$emit("addEvent", event);
            this.computetaskHours();
        },
        recalculatetaskHoursAndEmitAddEventReverse(event) {
            this.$emit("addEventReverse", event);
            this.computetaskHours();
        },
        recalculatetaskHoursAndEmitRemoveEvent(event) {
            this.$emit("removeEvent", event);
            this.computetaskHours();
        },
        recalculatetaskHoursAndEmitRemoveEventReverse(event) {
            this.$emit("removeEventReverse", event);
            this.computetaskHours();
        },
        onRowExpand({ item, index, expanded, expandedRows }) {
            if (item.events.length) {
                const resources = [...this.resources];
                resources[index].rowExpanded = expanded;
                this.$emit("resourcesChanged", resources);
            }
        },
        /**
        ...
        async loadLocale(locale) {
            ...
            if (this.locale === "en") {
                ...
                import(`./i18n/${locale}.json`).then((response) => {
        ...
        validateView(view) {
            if (!validViews.includes(view)) {
                // eslint-disable-next-line no-console
                console.error(
                    `Vue Cal: invalid active-view parameter provided: "${view}".\nA valid view must be one of: ${validViews.join(
                        ", "
                    )}.`
                );
                view = "week";
            ...
            if (!this.enabledViews.includes(view)) {
                // eslint-disable-next-line no-console
                console.warn(
                    `Vue Cal: the provided active-view "${view}" is disabled. Using the "${this.enabledViews[0]}" view instead.`
                );
        ...
        switchView(view, date = null, fromViewSelector = false) {
            ...
            const viewDateBeforeChange =
                this.view.startDate && this.view.startDate.getTime();

            if (this.transitions && fromViewSelector) {
                if (this.view.id === view) return;
                const views = this.enabledViews;
                this.transitionDirection =
                    views.indexOf(this.view.id) > views.indexOf(view)
                        ? "left"
                        : "right";
            }
            ...
            switch (view) {
                ...
                case "month": {
                    ...
                    if (
                        startDate.getDay() !== (this.startWeekOnSunday ? 0 : 1)
                    ) {
                        startDate = ud.getPreviousFirstDayOfWeek(
                            startDate,
                    ...
                    if (this.hideWeekends) {
                        ...
                        if ([0, 6].includes(this.view.firstCellDate.getDay())) {
                            const daysToAdd =
                                this.view.firstCellDate.getDay() === 6 &&
                                !this.startWeekOnSunday
                                    ? 2
                                    : 1;
                            this.view.firstCellDate = ud.addDays(
                        ...
                        if ([0, 6].includes(this.view.startDate.getDay())) {
                            const daysToAdd =
                                this.view.startDate.getDay() === 6 ? 2 : 1;
                            this.view.startDate = ud.addDays(
                                this.view.startDate,
                                daysToAdd
                            );
                        }
                        ...
                        if ([0, 6].includes(this.view.lastCellDate.getDay())) {
                            const daysToSubtract =
                                this.view.lastCellDate.getDay() === 0 &&
                                !this.startWeekOnSunday
                                    ? 2
                                    : 1;
                            this.view.lastCellDate = ud.subtractDays(
                        ...
                        if ([0, 6].includes(this.view.endDate.getDay())) {
                            const daysToSubtract =
                                this.view.endDate.getDay() === 0 ? 2 : 1;
                            this.view.endDate = ud.subtractDays(
                                this.view.endDate,
                                daysToSubtract
                            );
                        }
                ...
                case "week": {
                    if (date.getDay() != 6 && date.getDay() != 0) {
                        date = ud.getPreviousFirstDayOfWeek(
                            date,
                            this.startWeekOnSunday
                        );
                    }
                    const weekDaysCount = this.hideWeekends ? 5 : 12;
                    this.view.startDate =
         ...
         * @param {Boolean} next
         */
        previousNext(next = true, monthOrYearChanged = false, event) {
            setTimeout(() => {
                const ud = this.utils.date;
                ...
                switch (viewId) {
                    case "years":
                        firstCellDate = new Date(
                            startDate.getFullYear() + 25 * modifier,
                            0,
                            1
                        );
                        break;
                    case "year":
                        if (monthOrYearChanged) {
                            firstCellDate = new Date();
                            firstCellDate.setDate(startDate.getDate());
                            firstCellDate.setMonth(
                                this.monthsData.indexOf(
                                    event.target.name == "currentMonth"
                                        ? event.target.value
                                        : this.currentMonth
                                )
                            );
                            firstCellDate.setFullYear(
                                event.target.name == "currentYear"
                                    ? event.target.value
                                    : this.currentYear
                            );
                        } else {
                            firstCellDate = new Date(
                                startDate.getFullYear() + 1 * modifier,
                                1,
                                1
                            );
                        }
                    ...
                    case "week":
                        if (monthOrYearChanged) {
                            ...
                            firstCellDate = ud[
                                next ? "addDays" : "subtractDays"
                            ](
                                ud.getPreviousFirstDayOfWeek(
                                    startDate,
                                    this.startWeekOnSunday
                                ),
                                7
                        ...
                        break;
                    case "day":
                        firstCellDate = ud[next ? "addDays" : "subtractDays"](
                            startDate,
                            1
                        );
                        const weekDay = firstCellDate.getDay(); // 0 to 6 with Sunday at position 0.
                        const weekDayIndex = this.startWeekOnSunday
                            ? weekDay
                            : (weekDay || 7) - 1;
                        ...
                        if (isDayHidden) {
                            const daysWithIndex = this.weekDays.map(
                                (day, i) => ({
                                    ...day,
                                    i,
                                })
                            ...
                            if (next) {
                                dayToShow = [
                                    ...daysWithIndex.slice(weekDayIndex),
                                    ...daysWithIndex,
                                ].find((day) => {
                                    daysFromDate++;
                                    return !day.hide;
                                ...
                                dayToShow = [
                                    ...daysWithIndex,
                                    ...daysWithIndex.slice(0, weekDayIndex),
                                ]
                                    .reverse()
                                    .find((day) => {
                                        daysFromDate++;
        ...
        addEventsToView(events = []) {
            ...
            const { startDate, endDate, firstCellDate, lastCellDate } =
                this.view;
            ...
            let filteredEvents = events.filter((e) =>
                ue.eventInRange(e, startDate, endDate)
            );
            ...
            if (
                ...
                filteredEvents = filteredEvents.map((e) => {
                    return e.daysCount > 1
                        ? ue.createEventSegments(
                              e,
            ...
            if (this.isMonthView) {
                ...
                events.forEach((e) => {
                    if (
                        ue.eventInRange(e, firstCellDate, startDate) ||
                        ue.eventInRange(e, endDate, lastCellDate)
                    ) {
                        // Only add events to the view.outOfScopeEvents array if not already in view.events
                        // (multiple-day events case).
                        if (!this.view.events.some((e2) => e2._eid === e._eid))
         ...
         */
        onMouseMove(e) {
            const { resizeAnEvent, dragAnEvent, dragCreateAnEvent } =
                this.domEvents;
            if (
                resizeAnEvent._eid === null &&
                dragAnEvent._eid === null &&
                !dragCreateAnEvent.start
            )
                return;
        ...
        onMouseUp(e) {
            ...
            const { event: dragCreatedEvent, start: dragCreateStarted } =
                dragCreateAnEvent;
            ...
            if (wasResizing) {
                const { originalEnd, originalEndTimeMinutes, endTimeMinutes } =
                    resizeAnEvent;
                const event = this.view.events.find(
                    (e) => e._eid === resizeAnEvent._eid
                );
                // If end time is different than original, consider as resized.
                hasResized =
                    endTimeMinutes && endTimeMinutes !== originalEndTimeMinutes;
                ...
                if (event && event.end.getTime() !== originalEnd.getTime()) {
                    ...
                    const mutableEvent = this.mutableEvents.find(
                        (e) => e._eid === resizeAnEvent._eid
                    );
            ...
            if (
                ...
                let event = this.view.events.find(
                    (e) => e._eid === focusAnEvent._eid
                );
                // If not found, the event may be in the outOfScope array.
                if (!event && this.isMonthView)
                    event = this.view.outOfScopeEvents.find(
                        (e) => e._eid === focusAnEvent._eid
                    );
        ...
        eventResizing(e) {
            ...
            const segment =
                event.segments && event.segments[resizeAnEvent.segment];
            ...
            const newEndTimeMins = Math.max(
                minutes,
                this.timeFrom + 1,
                (segment || event).startTimeMinutes + 1
            );
            ...
            if (this.snapToTime) {
                const plusHalfSnapTime =
                    event.endTimeMinutes + this.snapToTime / 2;
                event.endTimeMinutes =
                    plusHalfSnapTime - (plusHalfSnapTime % this.snapToTime);
            }
            ...
            event.end.setHours(
                0,
                event.endTimeMinutes,
                event.endTimeMinutes === minutesInADay ? -1 : 0,
                0
            );
            ...
            if (this.resizeX && this.isWeekView) {
                ...
                if (resizeAnEvent.endCell !== endCell) {
                    ...
                    const newEnd = ud.addDays(
                        event.start,
                        endCell - resizeAnEvent.startCell
                    );
                    // Don't accept 0 and negative values.
                    const newDaysCount = Math.max(
                        ud.countDays(event.start, newEnd),
                        1
                    );
                    ...
                    if (newDaysCount !== event.daysCount) {
                        ...
                        if (newDaysCount > event.daysCount)
                            lastSegmentFormattedDate =
                                ue.addEventSegment(event);
                        else
                            lastSegmentFormattedDate =
                                ue.removeEventSegment(event);
        ...
        eventDragCreation(e) {
            ...
            if (
                !dragCreateAnEvent.event &&
                Math.abs(startCursorY - y) < this.dragToCreateThreshold
            )
                return;
            ...
            if (!dragCreateAnEvent.event) {
                ...
                dragCreateAnEvent.event = this.utils.event.createAnEvent(
                    start,
                    1,
                    {
                        split,
            ...
            // If the event already exists change its start and end.
                ...
                // Remove 1 second if time is 24:00.
                timeAtCursor.setHours(
                    0,
                    minutes,
                    minutes === minutesInADay ? -1 : 0,
                    0
                );
                ...
                if (this.snapToTime) {
                    let timeMinutes =
                        timeAtCursor.getHours() * 60 +
                        timeAtCursor.getMinutes();
        ...
        unfocusEvent() {
            ...
            const event = this.view.events.find(
                (e) => e._eid === (focusAnEvent._eid || clickHoldAnEvent._eid)
            );
        ...
        cancelDelete() {
            ...
            if (clickHoldAnEvent._eid) {
                const event = this.view.events.find(
                    (e) => e._eid === clickHoldAnEvent._eid
                );
        ...
        onEventTitleBlur(e, event) {
            ...
            this.$emit("event-change", {
                event: cleanEvent,
                originalEvent: { ...cleanEvent, title: oldTitle },
            });
        },
        ...
        createEvent(dateTime, duration, eventOptions = {}) {
            return this.utils.event.createAnEvent(
                dateTime,
                duration,
                eventOptions
            );
        ...
        alignWithScrollbar() {
            ...
            const bg = this.$refs.vuecal.getElementsByClassName(
        ...
        cellOrSplitHasEvents(events, split = null) {
            return (
                events.length &&
                ((!split && events.length) ||
                    (split && events.some((e) => e.split === split.id)))
            );
        },
    },
    ...
    mounted() {
        ...
        const hasEventClickHandler =
            this.onEventClick && typeof this.onEventClick === "function";
    ...
    computed: {
        ...
        ...mapGetters({
            loading: "vacationCalendarLoader",
        }),
        editEvents() {
            if (
                this.editableEvents &&
                typeof this.editableEvents === "object"
            ) {
                return {
        ...
        firstCellDateWeekNumber() {
            ...
            return ud.getWeek(
                this.startWeekOnSunday ? ud.addDays(date, 1) : date
            );
        },
        TimeFormat() {
        ...
        daySplits() {
            return (this.splitDays.filter((item) => !item.hide) || []).map(
                (item, i) => ({ ...item, id: item.id || i + 1 })
        ...
        weekDays() {
            ...
            weekDays = [...weekDays.slice(-5), ...weekDays]
                .slice(0)
                .map((day, i) => ({
                    label: day,
                    ...(weekDaysShort.length
                        ...
                        : {}),
                    hide:
                        (this.hideWeekends && i >= 5) ||
                        (this.hideWeekdays.length &&
                            this.hideWeekdays.includes(i + 1)),
                }));
            if (this.startWeekOnSunday) weekDays.unshift(weekDays.pop());
            //console.log('this.texts');
            //console.log([...weekDays.slice(-5), ...weekDays]);
            ...
            return Array(7)
                ...
                .map((cell, i) => {
                    ...
                    day.forEach(({ from, to, class: Class, label }, j) => {
                        cell[j] = {
                            day: i + 1,
                            from: ![null, undefined].includes(from)
                                ? from * 1
                                : null,
        ...
        viewTitle() {
            ...
            this.currentMonth = this.months[month].label.toLowerCase();
            ...
            switch (this.view.id) {
                ...
                case "week": {
                    ...
                    if (lastDayOfWeek.getMonth() !== date.getMonth()) {
                        ...
                        if (y1 === y2)
                            formattedMonthYear = `${m1} - ${m2} ${y1}`;
                        else {
                            if (this.small)
                                formattedMonthYear = `${m1.substring(
                                    0,
                                    3
                                )} ${y1} - ${m2.substring(0, 3)} ${y2}`;
                            else
                                formattedMonthYear = `${m1} ${y1} - ${m2} ${y2}`;
                        }
                    }
                    title = `${this.texts.week} ${ud.getWeek(
                        this.startWeekOnSunday ? ud.addDays(date, 1) : date
                    )} (${formattedMonthYear})`;
                    break;
                }
                case "day": {
                    title = this.utils.date.formatDate(
                        date,
        ...
        viewCells() {
            ...
            switch (this.view.id) {
                ...
                case "year": {
                    ...
                    cells = Array.apply(
                        null,
                        Array(12 * this.resources.length)
                    ).map((cell, i) => {
                        const basicUnit = 12;
                        let indexBoundaryChecker = basicUnit * multiplier;
                        let resourceIndex = multiplier - 1;
                        if (i % indexBoundaryChecker == 0 && i !== 0) {
                            multiplier += 1;
                            resourceIndex = multiplier - 1;
                        }
                        const firstCellDate = new Date();
                        firstCellDate.setDate(1);
                        firstCellDate.setMonth(i % 12);
                        firstCellDate.setFullYear(this.currentYear);
                        const startDate = firstCellDate;
                        let endDate = new Date();
                        if (
                            startDate.getMonth() ===
                            ud.addDays(startDate, 30).getMonth()
                        )
                            endDate = ud.addDays(startDate, 30);
                        else if (
                            startDate.getMonth() ===
                            ud.addDays(startDate, 29).getMonth()
                        )
                            endDate = ud.addDays(startDate, 29);
                        else if (
                            startDate.getMonth() ===
                            ud.addDays(startDate, 28).getMonth()
                        )
                            endDate = ud.addDays(startDate, 28);
                        else if (
                            startDate.getMonth() ===
                            ud.addDays(startDate, 27).getMonth()
                        )
                            endDate = ud.addDays(startDate, 27);
                        endDate.setSeconds(-1); // End at 23:59:59.
                        ...
                        return {
                            ...
                            endDate,
                            content: this.xsmall
                                ? this.months[i % 12].label.substr(0, 3)
                                : this.months[i % 12].label,
                            current:
                                i === now.getMonth() &&
                ...
                case "month": {
                    ...
                    const firstCellDate = new Date();
                    firstCellDate.setDate(1);
                    firstCellDate.setMonth(month);
                    firstCellDate.setFullYear(this.currentYear);
                    todayFound = false;

                    // Create 42 cells (6 rows x 7 days) and populate them with days.
                    let doesFifthWeekExist = false;
                    if (
                        firstCellDate.getMonth() ===
                        ud.addDays(firstCellDate, 28).getMonth()
                    ) {
                        doesFifthWeekExist = true;
                    }
                    this.$nextTick(() => {
                        Array.from(
                    ...
                    cells = Array.apply(
                        null,
                        Array(
                            (doesFifthWeekExist ? 5 : 4) * this.resources.length
                        )
                    ).map((cell, i) => {
                        const basicUnit = doesFifthWeekExist ? 5 : 4;
                        let indexBoundaryChecker = basicUnit * multiplier;
                        let resourceIndex = multiplier - 1;
                        if (i % indexBoundaryChecker == 0 && i !== 0) {
                            multiplier += 1;
                        ...
                        const startDate = ud.addDays(
                            firstCellDate,
                            (i % (doesFifthWeekExist ? 5 : 4)) * 7
                        );
                        let endDate = ud.addDays(startDate, 6);
                        if ((i % (doesFifthWeekExist ? 5 : 4)) * 7 == 28) {
                            if (
                                ud.addDays(startDate, 3).getMonth() ==
                                firstCellDate.getMonth()
                            ) {
                                endDate = ud.addDays(startDate, 3);
                            } else if (
                                ud.addDays(startDate, 2).getMonth() ==
                                firstCellDate.getMonth()
                            ) {
                                endDate = ud.addDays(startDate, 2);
                            } else if (
                                ud.addDays(startDate, 1).getMonth() ==
                                firstCellDate.getMonth()
                            ) {
                                endDate = ud.addDays(startDate, 1);
                            }
                        }
                        ...
                        return {
                            ...
                            class: `vuecal__cell--day${
                                startDate.getDay() || 7
                            }`,
                            resource: this.resources[resourceIndex],
                            weekNumber: (i % (doesFifthWeekExist ? 5 : 4)) + 1,
                        };
                    });
                    if (this.hideWeekends || this.hideWeekdays.length) {
                        cells = cells.filter((cell) => {
                            ...
                            return !(
                                (this.hideWeekends && day >= 6) ||
                                (this.hideWeekdays.length &&
                                    this.hideWeekdays.includes(day))
                            );
                        });
                    }
                    break;
                ...
                case "week": {
                    ...
                    todayFound = false;
                    const firstDayOfWeek = ud.subtractDays(
                        this.view.startDate,
                        5
                    );
                        ...
                        .map((cell, i) => {
                            ...
                            return {
                                ...
                                today:
                                    ...
                                    !todayFound++,
                                specialHours:
                                    this.specialDayHours[dayOfWeek] || [],
                            };
                        })
                        .filter((cell, i) => !weekDays[i].hide);
                      // alert('44');
                        this.calenderWeekDays=[...newWekkDays];
                        console.log(newWekkDays)
                        console.log(this.calenderWeekDays)
                    break;
                }
                case "day": {
                    const startDate = this.view.startDate;
            ...
            this.$emit("currentYear", this.currentYear);
            this.$emit("weekViewBoundary", {
        ...
        visibleDaysCount() {
            ...
            return (
                7 - this.weekDays.reduce((total, day) => total + day.hide, 0)
            );
        },
        cellWidth() {
        ...
        cssClasses() {
            ...
            return {
                ...
                "vuecal--short-events":
                    this.isMonthView && this.eventsOnMonthView === "short",
                "vuecal--has-touch":
