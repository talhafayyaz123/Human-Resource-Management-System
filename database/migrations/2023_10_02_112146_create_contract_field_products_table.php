...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('contract_field_products', function (Blueprint $table) {
            $table->id();
            $table->foreignId('contract_field_id')->references('id')->on('selected_contract_fields')->cascadeOnDelete();
    ...
    {
        Schema::dropIfExists('contract_field_products');
    }
};
