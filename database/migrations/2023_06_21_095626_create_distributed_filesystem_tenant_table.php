...
return new class extends Migration
{
    ...
    public function up()
    {
        if (Schema::hasTable('distributed_filesystem_tenant') == false) {
            Schema::create('distributed_filesystem_tenant', function (Blueprint $table) {
                $table->id();
    ...
    {
        Schema::dropIfExists('distributed_filesystem_tenant');
    }
};